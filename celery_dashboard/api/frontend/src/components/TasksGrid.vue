<template>
    <div>
                    ...
                    >
                        ...
                        <v-list>
                            <v-list-tile @click="cancelAll()">
                                <v-list-tile-title>
                                    <v-icon left dark color="error">delete_forever</v-icon>
                                    Cancel these jobs
                                </v-list-tile-title>
                            </v-list-tile>
                            <v-list-tile @click="requeueAll()">
                                <v-list-tile-title>
                                    <v-icon left dark color="success">replay</v-icon>
                                    Requeue these jobs
                                </v-list-tile-title>
                            </v-list-tile>
                        </v-list>
        ...
        <task-dialog :open-dialog="openDialog" v-on:taskdialogclosed="taskDialogClosed"
                     :task="taskToOpen"></task-dialog>
